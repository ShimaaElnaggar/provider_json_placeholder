...
class _PostsViewState extends State<PostsView> {
  ...
  Consumer<PostsProvider> postsConsumer() {
          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: Card(
                ...
                child: buildPostListTile(post, index, context, postsProvider),
              ),
            );
          },
        );
  ...
  ListTile buildPostListTile(
      Post post, int index, BuildContext context, PostsProvider postsProvider) {
    return ListTile(
      title: Padding(
